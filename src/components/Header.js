  ...
  return (
    <>
      <header className="flex justify-between items-center p-4 md:p-8 pb-0 pt-4 md:pt-12 mb-20">
        ...
        <nav className="hidden md:block">
          <ul className="flex items-center gap-4 text-black justify-between w-full angie uppercase text-md">
            ...
            <li>
              ...
              >
                <svg  className="feather feather-instagram" alt="Instagram Logo" xmlns="http://www.w3.org/2000/svg" width="17" height="17" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1" strokeLinecap="round" strokeLinejoin="round" ><rect x="2" y="2" width="20" height="20" rx="5" ry="5"/><path d="M16 11.37A4 4 0 1 1 12.63 8 4 4 0 0 1 16 11.37z"/><line x1="17.5" y1="6.5" x2="17.51" y2="6.5"/></svg>
              </a>
            </li>              
          </ul>
        </nav>
        ...
        >
<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" class="feather feather-menu"><line x1="3" y1="12" x2="21" y2="12"/><line x1="3" y1="6" x2="21" y2="6"/><line x1="3" y1="18" x2="21" y2="18"/></svg>
        </button>
      </header>
