...
export default function QuoteTwoImagesBlock({ block }) {
  const { quote, attribution, leftImage, leftAlt, rightImage, rightAlt, layout = 'quote-left', imageSize, bottomMargin, customBottomMargin } = block;
  ...
  return (
    <div className={`content-block quote-two-images-block ${marginProps.className} flex self-center justify-center ${widthClass}`} style={marginProps.style}>
